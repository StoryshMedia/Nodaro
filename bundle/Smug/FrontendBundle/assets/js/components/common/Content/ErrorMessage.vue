<template>
  <div
    class="w-full bg-error border border-error text-error px-4 py-3 rounded relative mt-2"
    role="alert"
  >
    <strong class="font-bold">{{ $t('ERROR_MESSAGE_HEADLINE') }}</strong>
    <span class="block sm:inline pl-5">{{ getMessage() }}</span>
    <span
