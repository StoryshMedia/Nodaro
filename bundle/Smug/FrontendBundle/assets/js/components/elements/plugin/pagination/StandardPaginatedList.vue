...
const StandardPagination = defineAsyncComponent(() =>
  import("../additional/Pagination/StandardPagination.vue" /* webpackChunkName: "standard-pagination" */)
);
