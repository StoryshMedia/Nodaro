...
const BigTilePaginationWrapper = defineAsyncComponent(() =>
  import("./BigTilePaginationWrapper.vue" /* webpackChunkName: "pagination-big-tile-wrapper" */)
);
...
export default {
  name: "BigTilePagination",
  components: {
    Pagination,
    BigTilePaginationWrapper
  },
  props: {
    listItems: {
      type: Array,
