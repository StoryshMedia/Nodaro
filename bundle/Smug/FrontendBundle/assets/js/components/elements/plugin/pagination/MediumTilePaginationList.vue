...
const MediumTilePagination = defineAsyncComponent(() =>
  import("../additional/Pagination/MediumTilePagination" /* webpackChunkName: "medium-tile-pagination" */)
);
...
export default {
  name: "MediumTilePaginationList",
  components: {
    MediumTilePagination,
    Loading,
    Alphabetical,
    Filters
  },
