...
const BigTilePagination = defineAsyncComponent(() =>
  import("../additional/Pagination/BigTilePagination" /* webpackChunkName: "big-tile-pagination" */)
);
  ...
  methods: {
    ...
    async getData() {
      ...
      await ApiService.post(
        ...
        this.lastPage = (response.lastPage) ? response.lastPage : response.pages.end;
        this.$nextTick(()=> {
          this.configuration.allFilters = response.filters;
