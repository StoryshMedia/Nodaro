<template>
  ...
  >
    ...
    >
      ...
      >
        <medium-tile-pagination-wrapper
...
const MediumTilePaginationWrapper = defineAsyncComponent(() =>
  import("./MediumTilePaginationWrapper" /* webpackChunkName: "pagination-medium-tile-wrapper" */)
);
...
export default {
  name: "MediumTilePagination",
  components: {
    Pagination,
    MediumTilePaginationWrapper
  },
  props: {
    listItems: {
      type: Array,
