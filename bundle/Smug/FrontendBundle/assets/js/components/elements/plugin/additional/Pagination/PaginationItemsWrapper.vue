...
const PaginationCard = defineAsyncComponent(() =>
  import("./PaginationCard.vue" /* webpackChunkName: "pagination-card" */)
);

export default {
  name: "PaginationItemsWrapper",
  components: {
    PaginationCard
  },
  props: {
  ...
  methods: {
    ...
    getGridClass() {
      return 'col-start-2 md:col-start-0 col-span-10 md:col-span-6 lg:col-span-6 xl:col-span-4 2xl:col-span-3 h-100';
    },
    getLink(item) {
