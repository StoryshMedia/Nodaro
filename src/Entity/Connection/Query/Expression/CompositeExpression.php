...
namespace Smug\Core\Entity\Connection\Query\Expression;
...
class CompositeExpression extends \Doctrine\DBAL\Query\Expression\CompositeExpression
{
    ...
    public function __construct($type, array $parts = [])
    {
        ...
        $callingFile = DataHandler::fixWindowsFilePath((string)($backTrace[0]['file'] ?? ''));
        if ($callingFile !== DataHandler::fixWindowsFilePath(__FILE__)) {
            trigger_error(
